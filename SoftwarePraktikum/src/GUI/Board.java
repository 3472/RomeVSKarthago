...
public class Board extends JPanel {
	...
	public void paint(Graphics g) {
		...
		while (pathIterator.hasNext()) {
			...
			g.drawLine(tmpPathRef.getFirstCity().getXLocation(), tmpPathRef
					.getFirstCity().getYLocation(), tmpPathRef.getSecondCity()
					.getXLocation(), tmpPathRef.getSecondCity().getYLocation());
		}
		...
		for (City c : city_graph) {
			...
			g.drawString(drawString, cityMidX - (3 * drawString.length()),
					cityMidY + 5);
