...
public class Move {
	 ...
	 * 
	 * @param instruction
	 * @return Move der instruction ausführt
	 */
	...
	public Move createMoveFromString(String instruction) {
		...
		if (owner.equals(Character.toString('R')))
			player = Player.Rom;
		else if (owner.equals(Character.toString('C')))
			player = Player.Cathargo;
	...
	public String toString() {
		...
		return player == Player.Rom ? "R " + targetCityID : "C" + " "
				+ targetCityID;
	}
