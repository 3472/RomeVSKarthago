...
public class VertexSet implements Iterable<City>{
	...
	/**
	 * adds all Citys from the VertexSet,
	 * witch are not already in the set
	 * @param s
	 */
	...
	/**
	 * if needed "containsID()" should
	 * be checked first, if it's possible
	 * that the id is not inside the container
	 * 
	 * returns null if the Container does not
	 * contain the id
	 * 
	 * @param id
	...
	/**
	 * 
	 * @return Iterator over all CityIDs
	 ...
	 * 
	 * @param id
	 * @return true if the VertexSet
	 * Contains the given id, if not: false
	 */
	...
	/**
	 * 
	 * @param that VertexSet to compare
	 * @return true if the VertexSets contain
	 * the same Citys
	 */
